    ...
    <script>
        ...
        function delete_user(id) {
            ...
            if(r === true){
                ...
                location.href='backend/deleteUser.php?id='+ id;
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">รายชื่อผู้ใช้</h2>
                ...
                <div class="col-sm-6 col-md-6 col-xs-6">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $resultAccount["username"];  ?></td>
                                <td id="t2"><?php echo $resultAccount["password"];  ?></td>
                                <td id="t2"><?php echo $resultAccount["email"];  ?></td>
                                <td id="t2"><?php echo $resultAccount["role"];  ?></td>
                                <td><button class="btn btn-danger" onclick="delete_user(<?php echo $resultAccount["id"]; ?>)"> Delete </button></td>
                            </tr>
